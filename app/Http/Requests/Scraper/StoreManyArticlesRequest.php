...
use App\Http\Requests\Scraper\Traits\ValidatesManyArticlesTrait;
use App\Rules\UniqueArticlePerIssue;
use Illuminate\Foundation\Http\FormRequest;

class StoreManyArticlesRequest extends FormRequest
{
    use ValidatesManyArticlesTrait, EntitiesFind;
    /**
